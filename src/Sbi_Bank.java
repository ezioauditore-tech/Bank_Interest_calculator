...
public class Sbi_Bank extends Interest_calc{
    ...
    void show() {
        ...
        if(type_loan==3){
            ...
            System.out.println("The principal Amount is: Rs."+amount+"\n"+"The Interest Amount is: Rs."+Sbi_Bank.cal(amount,t,type_loan)+
            ...
            System.out.print("Enter the Time period : ");
            float t = sc.nextFloat();
            System.out.println("The Interest Amount is: "+Sbi_Bank.cal(pr,t,type_loan)+ "\n And the Period Of Replacement is: "+t+" Years");
        }
