...
public class Axis_Bank extends Interest_calc{
    ...
    static float cal(int pr,float t,int type_loan){
        if(type_loan==1){
            ...
            {
                System.out.println("The time period should be less than 30 years bruh!");
            }
        }
        else if(type_loan==2){
            if(t<7){
            ...
            {
                System.out.println("The time period should be less than 7 years bruh!");
            }
        }
        else if(type_loan==4){
            if(t<5){
            ...
            {
                System.out.println("The time period should be less than 5 years bruh!");
            }
        }
        return interest;
    }
    ...
    void show() {
        ...
        if(type_loan==3){
            ...
            System.out.print("Enter the Time period : ");
            float t = sc.nextFloat();
            System.out.println("The Interest Amount is: "+Axis_Bank.cal(pr,t,type_loan)+ "\n And the Period Of Replacement is: "+t+" Years");
        }
